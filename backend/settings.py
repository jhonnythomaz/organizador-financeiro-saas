...
SECRET_KEY = 'django-insecure-%*$3b05sxgc(#$-uv)0z0qhp6&qv&t^qzj^qy%haee1h=@fov8'
...
INSTALLED_APPS = [
    ...
    'django_filters',  # << 1. ADICIONADO AQUI
    # Apps de terceiros
    'corsheaders',
    'rest_framework',
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # A origem do nosso futuro app React
    "http://127.0.0.1:3000",
]

# Para desenvolvimento, podemos permitir todas as origens para simplificar os testes com Insomnia
